        ...
        <div className='flex items-center justify-between'>
            <div className='flex items-center gap-[10px]'>
                ...
                <div className='leading-[20px]'>
                  <h2 className='text-xl text-smallTextColor font-[700]'>Pranto</h2>
            ...
            <div className="flex items-center gap-4">
              <button className='flex items-center gap-2 text-smallTextColor font-[600] border border-solid border-smallTextColor py-2 px-4 rounded-[8px] max-h-[40px] hover:bg-smallTextColor hover:text-white hover:font-[500] eas duration-300'>
                <MdPhoneInTalk/> Let's Talk
              </button>
