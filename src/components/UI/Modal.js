...
const portfolio = portfolios.find(portfolio => portfolio.id === activeID)
  ...
  return (
    <div className='w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40'>
        <div className='w-11/12 md:max-w-[600] md:w-full absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform -translate-x-1/2 -translate-y-1/2 p-5'>
            <div>
                <figure>
            ...
            <div>
                <h2 className='text-2xl text-headingColor font-[700] mt-5'>
                    {portfolio.title}
                </h2>
